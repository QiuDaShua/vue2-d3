...
<script lang="ts">
  ...
  import { fetchEquityBelowInfo } from '@/api/companySearch'
  ...
  export default defineComponent({
    ...
    methods: {
      // changeOrient () {
      //   const box = document.getElementById('structureChartOut').children[0]
      //   const g = document.getElementById('structureChartOut').children[0].children[0]
      ...
      init () {
        ...
        // 主图
        this.svg = d3.select('#structureChartOut').append('svg').attr('width', svgW).attr('height', svgH).attr('id', 'treesvgOut')
    ...
    /*
        ...
        */
        ...
        let linkEnter = link.enter().insert('path', 'g')
          ...
          // .attr('marker-end', 'url(#resolvedOut)')// 根据箭头标记的id号标记箭头
          .attr('stroke', '#DE4A3C')
